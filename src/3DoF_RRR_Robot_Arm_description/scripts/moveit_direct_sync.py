#!/usr/bin/env python3
"""
MoveIt Direct Angle Sync (Calibration + Clean Output Edition)
============================================================
...
class MoveItDirectSync(Node):
    def __init__(self):
        super().__init__('moveit_direct_sync')
    ...
    def control_loop(self):
        ...
        # So the user only sees the clean angle from MoveIt.
        display_degs = [
    ...
    def stop(self):
        if self.connected: self.port_handler.closePort()
